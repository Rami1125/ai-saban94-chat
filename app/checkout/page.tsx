...
import { Sparkles, ShoppingCart, Palette, CheckCircle2, Search, X, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#FCF9F5] pb-32" dir="rtl">
      ...
      <main className="p-6 max-w-xl mx-auto space-y-8">
        {/* כפתורי אפליקציה מרובעים מגושמים */}
        <div className="grid grid-cols-2 gap-4">
          ...
          <Dialog>
            <DialogTrigger className="bg-white h-36 rounded-[2.5rem] border-4 border-white shadow-md flex flex-col items-center justify-center gap-3 active:scale-95">
      ...
      {/* AI Assistant Popup - יועץ מומחה */}
      <Dialog open={isAiOpen} onOpenChange={setIsAiOpen}>
        <DialogContent className="bg-white/95 backdrop-blur-2xl border-none rounded-[3rem] p-10 text-center shadow-[0_0_100px_rgba(37,99,235,0.2)]">
          ...
          <div className="space-y-3">
             ...
             <p className="text-[10px] text-slate-300 font-bold uppercase tracking-widest">Powered by Saban AI v3</p>
          </div>
        </DialogContent>
      </Dialog>
      ...
      {/* Footer Summary */}
      <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-3xl border-t p-8 rounded-t-[3.5rem] shadow-[0_-20px_50px_rgba(0,0,0,0.05)] z-50">
