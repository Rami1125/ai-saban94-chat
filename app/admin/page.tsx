...
import { 
  ...
  ExternalLink, 
  Database,
  Sparkles // <--- זה האייקון שהיה חסר וגרם לשגיאה
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#020617] text-white p-6 lg:p-12 space-y-10" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
        <Card className="lg:col-span-2 bg-slate-900/40 border-white/5 backdrop-blur-xl rounded-[40px] overflow-hidden shadow-2xl">
          <CardHeader className="p-8 border-b border-white/5 bg-white/5 text-white">
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-blue-700 p-10 rounded-[45px] shadow-2xl relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <p className="text-blue-100/70 text-sm font-bold mt-4">
                נמצאו {stats.missingMedia} מוצרים ללא תמונה. האם להפעיל את Gemini?
              </p>
              <button className="w-full bg-white text-blue-900 py-5 rounded-[22px] font-black text-sm mt-8 shadow-xl hover:scale-[1.02] transition-all">
                הפעל סוכן העשרה
              </button>
            </div>
          </div>
