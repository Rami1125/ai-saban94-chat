        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Live PWA Sync</span>
            </div>
          </div>
        </div>
              ...
              <Card className="rounded-[3rem] border-none shadow-2xl overflow-hidden bg-white">
                ...
                <CardContent className="p-10">
                  <Textarea 
                    ...
                    className="min-h-[450px] text-xl rounded-[2rem] border-slate-200 p-8 leading-relaxed focus:ring-4 focus:ring-blue-100 transition-all"
              ...
              <Card className="rounded-[3rem] border-none shadow-2xl overflow-hidden bg-white">
                ...
                <div className="max-h-[550px] overflow-y-auto p-4">
                  <table className="w-full text-right">
                    ...
                    <tbody>
                      {inventory.map(item => (
                        <tr key={item.id} className="hover:bg-blue-50 transition-all border-b border-slate-50">
          ...
          <div className="relative border-[14px] border-slate-900 bg-slate-900 rounded-[4rem] h-[820px] w-[380px] shadow-2xl overflow-hidden">
            ...
            <div className="h-full bg-[#F8FAFC] flex flex-col pt-10 relative">
              ...
              <div className="p-5 bg-white/90 backdrop-blur-xl border-t flex gap-3">
                ...
                />
                <button onClick={simulateChat} className="bg-blue-600 text-white p-4 rounded-2xl shadow-lg active:scale-90 transition-all">
                  <Send size={22}/>
                </button>
              </div>
              {/* תיקון השגיאה כאן: הוספת הגרשיים החסרים וסגירת הדיב */}
